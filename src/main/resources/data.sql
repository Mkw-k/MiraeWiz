...
('ABOUT_HISTORY', '2025.01 미래위즈 설립\n2025.06 WW Kingdom: 중등 영단어 출시', '회사 연혁');
...
('우등생A', '진짜 게임하는 것 같아서 시간 가는 줄 모르고 공부했어요. 중학 필수 단어가 다 있어서 너무 좋아요!', 5, TRUE),
('학부모님', '아이가 영단어 외우는 걸 너무 싫어했는데 이 앱은 스스로 켜서 하네요. 감사합니다.', 5, TRUE),
('열공이', '디자인이 깔끔하고 리스닝까지 같이 할 수 있어서 편해요.', 4, FALSE);
